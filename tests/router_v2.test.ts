...
describe('Test Router V2 Module', () => {
  ...
  test('Test router swap with partner', async () => {
    const coin_a = TestnetCoin.MAGMA
...
export async function execTx(sdk: MagmaClmmSDK, simulate: boolean, payload: Transaction, sendKeypair: Ed25519Keypair | Secp256k1Keypair) {
  if (simulate) {
